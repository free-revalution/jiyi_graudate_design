    ...
    <div class="main-tab">
        ...
        <div class="bg-white radius8 p20 mb10">
            <div class="flx-center mb10">
                ...
                <el-input v-model="exerciseForm.name" class="exercise-name-input ml10" placeholder="请输入练习名称" />
            </div>
            <el-row :gutter="20" class="mt20">
                <el-col :span="8">
                    <div class="form-item">
                        <span class="form-label">练习类型</span>
                        <el-radio-group v-model="exerciseForm.type">
                            <el-radio value="question">题目型练习</el-radio>
                            <el-radio value="answer">答题卡练习</el-radio>
                        </el-radio-group>
                    </div>
                </el-col>
                <el-col :span="10">
                    <div class="form-item">
                        ...
                        <el-radio-group v-model="exerciseForm.scoreType">
                ...
                <el-col :span="6">
                    <div class="form-item">
                        ...
                        <el-radio-group v-model="exerciseForm.questionGroup">
            ...
            <div class="question-editor">
                ...
                <div class="add-question-bar">
                    ...
                    <div class="question-types">
                        ...
                        <el-button :type="currentType === 'blank' ? 'primary' : 'default'" plain
                            @click="selectQuestionType('blank')">填空题</el-button>
                    </div>
...
<script setup lang="ts" name="courseManageClassExerciseAction">
...
const getQuestionTypeName = (type: string) => {
    const map: Record<string, string> = { single: "单选题", multiple: "多选题", blank: "填空题" };
...
const saveQuestion = () => {
    ...
    const question = {
        ...
        options: currentType.value !== "blank" ? [...questionForm.options.map(o => ({ ...o }))] : [],
...
const toPreview = () => {
    const exerciseData = {
        exerciseInfo: {
            ...
            scoreType: exerciseForm.scoreType,
            questionGroup: exerciseForm.questionGroup
        },
        questionList: questionList.value
    };
    sessionStorage.setItem("exerciseEditData", JSON.stringify(exerciseData));
    router.push(`/courseManage/classExercise/preview/${route.params.id || "add"}`);
};

onMounted(() => {
    const savedData = sessionStorage.getItem("exerciseEditData");
    if (savedData) {
        const data = JSON.parse(savedData);
        if (data.exerciseInfo) {
            exerciseForm.name = data.exerciseInfo.name || generateExerciseName();
            exerciseForm.type = data.exerciseInfo.type || "question";
            exerciseForm.scoreType = data.exerciseInfo.scoreType || "average";
            exerciseForm.questionGroup = data.exerciseInfo.questionGroup || "byType";
        }
